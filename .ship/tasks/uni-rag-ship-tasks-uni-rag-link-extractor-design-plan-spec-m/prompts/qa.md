...
e2e_report: .ship/tasks/uni-rag-ship-tasks-uni-rag-link-extractor-design-plan-spec-m/e2e/report.md  (may exist — lists what was codified)
...
Write reports to: .ship/tasks/uni-rag-ship-tasks-uni-rag-link-extractor-design-plan-spec-m/qa/
